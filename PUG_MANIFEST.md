...
2. **SNIFF:** `pug sniff [URL]` — Playwright scrapes the URL, saves Markdown under `bones/<bone>/`.
3. **CHEW:** `pug chew` — AI reads the sniff, suggests CLI commands + flags (Bone Map), saves `bones/<bone>/bone_map.json`.
